...
To update the database use this command from the Web project folder (replace `App` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../App.Infrastructure/App.Infrastructure.csproj -s App.Web.csproj
```
